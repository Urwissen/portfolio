    ...
    return(
        <footer className={`footer container ${props.darkMode}`}>
            ...
            <div className="contact-container">
                ...
                <h3 className="impressum" onClick={handleClick}>Impressum</h3>
            </div>
            <div className="impressum-text" style={isOpen ? {display: "block"} : {display: "none"}}>
                <p>Angaben gemäß § 5 TMG</p>
                <p>Lars Gessner</p>
                <p>Neckarstr. 119, 70190 Stuttgart</p>
                <p>l.gessner(at)posteo.de</p>
                <aside>
                Haftungsausschluss:
